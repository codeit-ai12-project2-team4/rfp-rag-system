...
- 텍스트 추출 성공률 98/100(98.0%). 나머지 2건은 세 추출기 모두 실패.
...
- □ 항목 상위권이 "법률 및 고시"(65건 문서), "서비스 접근 및 전달 분야"·"인터페이스 및 통합 분야"·"플랫폼 및 기반구조 분야"·"요소기술 분야"(각 64건), "보안 분야"(62건)로, 대부분 문서가 같은 표준 카테고리 세트를 반복하고 있었다.
