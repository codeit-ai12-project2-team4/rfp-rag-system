...
from preprocessing.fields import CSV_COLUMNS
...
# **`공개기관` 이 빠졌다.** CSV 에도 크롤러 HEADER 에도 없는 컬럼이라
# 전처리를 돌릴 때마다 "없는 컬럼(건너뜀)" 을 찍고 있었다.
ORIGINAL_METADATA_COLUMNS = CSV_COLUMNS
